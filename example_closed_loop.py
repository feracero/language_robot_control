...
# Do closed-loop control in language space
while robot_position[0] != goal_position[0] or robot_position[1] != goal_position[1]:
    ...
    first_step = steps[0]
    robot_manager.execute_step(first_step)
    robot_position = step_robot_position(robot_position, first_step)
    grid = np.zeros((grid_size, grid_size), dtype=str)
    grid[robot_position[0], robot_position[1]] = "o"
    grid[goal_position[0], goal_position[1]] = "x"
    print(f"Grid after taking step '{first_step}':")
    print(grid)
